...
#iteration pulling just first names
def iterate_dictionary(key_name, students):
    for student in students:
        # for key, val in students: #not needed used for inner list
        #     print(f'{key} + {val}')
...
#iteration pulling just last names 
def iterate_dictionary(value_name, students):
    for student in students:
        # for key, val in students: #not needed used for inner list
        #     print(f'{key} + {val}')
        print(student[value_name] +" " )
