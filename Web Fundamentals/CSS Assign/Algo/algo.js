...
/* This makes no sense as it does not function, and how does i reference anything not being defined anywhere?
...
*/
  ...
  /*  function checkValue(x){
        return x > document.getElementById(searchItem).value
    }
    function myFunction(){
        document.getElementById(expected).innerHTML = numbers.findIndex(expected)
    }  */
}
