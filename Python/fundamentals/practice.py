...
# print(f'{user_mickey.first_name}{user_mickey.extra}')  #used for an earlier version where user was definied in it's own class
# print(f'{user_john.first_name}{user_john.extra}')  #used for an earlier version where user was definied in it's own class
